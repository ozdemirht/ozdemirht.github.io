...
1. [Chat with your book (LLM with RAG)](https://github.com/ozdemirht/generative-ai/tree/main/RAG0) (streamlit, LangChain, OpenAI) (2025)
  ...
  - [Vector stores with FAISS, indexing and search visualization] (FAISS, Dimension reduction(t-SNE, PCA), 2D/3D Visualization (Matplotlib, Plotly), LangChain, Hugging Face, Local LLM)
