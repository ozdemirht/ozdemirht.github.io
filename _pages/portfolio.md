...
1. [Chat with your book (LLM with RAG)](https://github.com/ozdemirht/generative-ai/tree/main/RAG0) (streamlit, LangChain, OpenAI) (2025)
  ...
  - [Note: Elasticsearch for Semantic Search](https://github.com/ozdemirht/py_redis_1/blob/master/docs/Note-ESearch-Semantic.ipynb) (Elasticsearch, Semantic search, dense vectors, Text Embedding, Sentence-Transformers, Hugging Face (), Python) 
