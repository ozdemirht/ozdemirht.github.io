...
------
1. [Vibe Coding with Google AI Studio: HeartGuard Hypertension Assistant](https://medium.com/@ozdemirtim/vibe-coding-with-google-ai-studio-b0b3246a9a49) (2025)
...
1. [System Design: Food Delivery System, Proximity Search](https://medium.com/@ozdemirtim/system-design-food-delivery-system-a08364d680cd) (2025)
  ...
  - [Note: PostgreSQL and PostGIS for Nearest Neighbour Query / Proximity Search](https://github.com/ozdemirht/py_redis_1/blob/master/docs/Note-Postgresql-Spatial.ipynb) (Postgresql, PostGIS, SP-GiST, psycopg2, NNQ, Python)
  ...
  - [Note: GIS](https://github.com/ozdemirht/py_redis_1/blob/master/docs/Note-GIS.ipynb) (Python, SQL)
  - [Note: Distributed Interactive Simulation (DIS) and High-Level Architecture (HLA)](https://github.com/ozdemirht/py_redis_1/blob/master/docs/Note-DIS.ipynb) (Python)
